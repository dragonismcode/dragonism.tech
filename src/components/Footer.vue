  ...
  <div class="hero-simple-centered">
    <div class="mt-5 mb-5 mx-auto max-w-screen-xl">
      <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
        ...
        <a href="https://twitch.tv/dragonismlive"><svg
          class="mx-3 fill-red-500 hover:fill-red-400 focus:outline-none focus:ring-primary transition duration-150 ease-in-out"
          width="25"
          height="25"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://www.reddit.com/u/dragonismdiscord"><svg
          class="mx-3 fill-red-500 hover:fill-red-400 focus:outline-none focus:ring-primary transition duration-150 ease-in-out"
          width="25"
          height="25"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://github.com/dragonismcode"><svg
          class="mx-3 fill-red-500 hover:fill-red-400 focus:outline-none focus:ring-primary transition duration-150 ease-in-out"
          width="25"
          height="25"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://gitlab.com/dragonism"><svg
          class="mx-3 fill-red-500 hover:fill-red-400 focus:outline-none focus:ring-primary transition duration-150 ease-in-out"
          width="25"
          height="25"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://open.spotify.com/user/x7e6756fethjut8yktd09t1nk?si=dd45aa39bef247da"><svg
          class="mx-3 fill-red-500 hover:fill-red-400 focus:outline-none focus:ring-primary transition duration-150 ease-in-out"
          width="25"
          height="25"
          xmlns="http://www.w3.org/2000/svg"
